          ...
          <div class="container">
               <div class="row">
                    ...
                    <div class="col-md-4 col-sm-5">
                         <p>Welcome to MYCARE HOSPITAL</p>
                    </div>
                         
                    <div class="col-md-8 col-sm-7 text-align-right">
                         <span class="phone-icon"><i class="fa fa-phone"></i>9995559990</span>
                         <span class="date-icon"><i class="fa fa-calendar-plus-o"></i> 6:00 AM - 10:00 PM (Mon-Fri)</span>
                         <span class="email-icon"><i class="fa fa-envelope-o"></i> <a href="#">mycarehospital2022@gmail.com</a></span>
                    </div>
     ...
     <section class="navbar navbar-default navbar-static-top" role="navigation">
          <div id="google_element"class="container">
               ...
               <div class="navbar-header">
                    ...
                    <!-- lOGO TEXT HERE -->
                    <a href="index.php" class="navbar-brand">MYCARE</a>
               </div>
...
<li><b>Mutual trust & respect:</b> We do not discriminate against anyone on any grounds. Respect is a traditional trait in us and we respect everyone, for we believe that trust grows respect, which forms the foundation of real success.</li>
                         ...
                         <form id="appointment-form" role="form" method="post" action="#">
                              ...
                              <!-- <div class="wow fadeInUp" data-wow-delay="0.8s">
                                   ...
                                   <div class="col-md-12 col-sm-12">
                                        ...
                                        <button type="submit" class="form-control" id="cf-submit" name="submit"><a href="login.php">Book Appointment</button> 
                                   </div>
                              </div>
                        </form>
                    </div>
	...
	-->
     <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d62865.558192703866!2d76.31557539786823!3d10.008814159290683!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3b080c8e94a07a07%3A0x49921cdfae82660!2sKakkanad%2C%20Kerala%2C%20India!5e0!3m2!1sen!2sth!4v1666524604766!5m2!1sen!2sth" width="1700" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>     </section>           
               ...
               <div class="row">
                    ...
                    <div class="col-md-4 col-sm-4">
                         <div class="footer-thumb"> 
                              ...
                              <p>Residence building,kakkanad,kochi,682021</p>

                              <div class="contact-info">
                                   <p><i class="fa fa-phone"></i>9995559990</p>
                                   <p><i class="fa fa-envelope-o"></i> <a href="#">mycarehospital2022@gmail.com</a></p>
                              </div>
                         </div>
                    </div>
                    ...
                    <div class="col-md-4 col-sm-4"> 
                         <div class="footer-thumb">
                              <div class="opening-hours">
                                   ...
                                   <p>Sunday <span>09:00 AM - 08:00 PM</span></p>
                              </div> 

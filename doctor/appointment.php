...
?>
  <div class="sidebar">
    ...
    <div class="container">
        ...
        <div class="dash-body">
            <table border="0" width="130%" style=" border-spacing: 0;margin:0;padding:0;margin-top:25px; ">
                <tr >
                    <td width="10%" >
                    <a href="appointment.php" ><button  class="login-btn btn-primary-soft btn btn-icon-back"  style="padding-top:11px;padding-bottom:11px;margin-left:20px;width:125px"><font class="tn-in-text">Back</font></button></a>
                    </td>
                    <td>
                        <p style="font-size: 23px;padding-left:80px;font-weight: 500;">Appointment</p>
                                ...
                                for ( $x=0; $x<$result->num_rows;$x++){
                                    ...
                                    echo '<tr >
                                       ...
                                       &nbsp;&nbsp;&nbsp;</div>
                                        ...
                                        <button type="submit" value='.$pid.' name="p">Prescribe</button></form>
